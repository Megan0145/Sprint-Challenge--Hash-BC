...
def get_indices_of_item_weights(weights, length, limit):
    ...
    for index in range(len(weights)):
        ...
        # else if it exists and is less than the value of the current index in the weights array
        elif exists_in_ht and exists_in_ht < index:
            # return tuple with value of current index and the value of exists_in_ht
            return (index, exists_in_ht)
        # else if it exists and is more than the value of the current index in the weights array
        else:
